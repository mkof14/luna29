...
const ADMIN_UI_COPY = {
  ...
  ar: {
    inviteTitle: 'الدعوات وصلاحيات الأدوار',
    inviteHint: 'أرسلي روابط دعوة وعيّني دور الإدارة الأول قبل أول تسجيل دخول.',
    inviteEmailPlaceholder: 'بريد الدعوة',
    inviteButton: 'إرسال دعوة',
    invitePending: 'قيد الانتظار',
    inviteSent: 'تم الإرسال',
    inviteAccepted: 'مقبولة',
    usersTitle: 'المستخدمات والجمهور',
    usersTotal: 'إجمالي المستخدمات',
    usersActive: 'نشطات اليوم',
    usersNew7d: 'جديدات خلال 7 أيام',
    siteStatsTitle: 'إحصائيات الموقع',
    dau: 'DAU',
    wau: 'WAU',
    mau: 'MAU',
    conversion: 'تحويل التسجيل',
    growth: 'النمو الأسبوعي',
    storageTitle: 'خزنة التخزين',
    addFolder: 'إضافة مجلد',
    previewHint: 'معاينة القوالب والرسائل متاحة أسفل كل عنصر.',
    noPreview: 'لم يُحدَّد شيء بعد. اختاري معاينة قالب أو حملة.',
  },
  he: {
    inviteTitle: 'הזמנות והרשאות תפקיד',
    inviteHint: 'שלחי קישורי הזמנה וקבעי תפקיד ניהול ראשוני לפני ההתחברות הראשונה.',
    inviteEmailPlaceholder: 'אימייל להזמנה',
    inviteButton: 'שליחת הזמנה',
    invitePending: 'ממתין',
    inviteSent: 'נשלח',
    inviteAccepted: 'התקבל',
    usersTitle: 'משתמשות וקהל',
    usersTotal: 'סה״כ משתמשות',
    usersActive: 'פעילות היום',
    usersNew7d: 'חדשות ב-7 ימים',
    siteStatsTitle: 'סטטיסטיקות אתר',
    dau: 'DAU',
    wau: 'WAU',
    mau: 'MAU',
    conversion: 'המרת הרשמה',
    growth: 'צמיחה שבועית',
    storageTitle: 'כספת אחסון',
    addFolder: 'הוספת תיקייה',
    previewHint: 'תצוגה מקדימה של תבניות והודעות זמינה מתחת לכל פריט.',
    noPreview: 'עדיין לא נבחר כלום. בחרי תצוגה מקדימה של תבנית או קמפיין.',
  },};
...
const CHANNELS_COPY = {
  ...
  ar: { title: 'القنوات والتكاملات', socialTitle: 'إدارة وسائل التواصل', socialHint: 'اربطي الحسابات، راقبي المزامنة، واحتفظي بأداء القنوات في مكان واحد.', emailTitle: 'ربط نظام البريد', emailHint: 'تحكّمي بحالة المزوّد وجودة التسليم وصحة قائمة انتظار رسائل النظام.', connect: 'ربط', disconnect: 'قطع', syncNow: 'مزامنة الآن', addChannel: 'إضافة قناة', channelName: 'اسم القناة', handle: 'المعرّف', followers: 'المتابعات', engagement: 'التفاعل', statusConnected: 'متصل', statusDisconnected: 'غير متصل', provider: 'المزوّد', fromEmail: 'بريد المرسل', domain: 'النطاق', queue: 'قائمة الانتظار', sentToday: 'أُرسل اليوم', bounced: 'مرتجع', openRate: 'معدل الفتح', testConnection: 'اختبار الاتصال', spf: 'SPF', dkim: 'DKIM', connectedNow: 'تم ربط القناة.', disconnectedNow: 'تم قطع القناة.' },
  he: { title: 'ערוצים ואינטגרציות', socialTitle: 'ניהול רשתות חברתיות', socialHint: 'חברי חשבונות, עקבי אחר סנכרון וביצועי ערוצים במקום אחד.', emailTitle: 'חיבור מערכת אימייל', emailHint: 'שליטי בספק, באיכות המסירה ובבריאות תור המיילים.', connect: 'חיבור', disconnect: 'ניתוק', syncNow: 'סנכרון עכשיו', addChannel: 'הוספת ערוץ', channelName: 'שם ערוץ', handle: 'מזהה', followers: 'עוקבות', engagement: 'מעורבות', statusConnected: 'מחובר', statusDisconnected: 'מנותק', provider: 'ספק', fromEmail: 'אימייל שולח', domain: 'דומיין', queue: 'תור', sentToday: 'נשלח היום', bounced: 'חזר', openRate: 'שיעור פתיחה', testConnection: 'בדיקת חיבור', spf: 'SPF', dkim: 'DKIM', connectedNow: 'הערוץ חובר.', disconnectedNow: 'הערוץ נותק.' },};

const defaultMarketingBody = 'A calm update for your rhythm. Gentle reminder with clear next action.';
const defaultTemplateBody = 'You are in a safe space. Observe your rhythm softly and stay connected with your body.';
...
const DEFAULT_CONTENT: ContentItem[] = [
  {
    ...
    body: seedLocalizedText('Check-in reminder. Pause for one breath and mark your current state.', 'en'),
    channel: 'Email',
    status: 'Scheduled',
...
const DEFAULT_TEMPLATES: EmailTemplate[] = [
  {
    ...
    subject: seedLocalizedText('Welcome', 'en'),
    preheader: seedLocalizedText('Your rhythm starts here.', 'en'),
    body: seedLocalizedText('Your private rhythm map is ready. Start with one gentle check-in today.', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Reset your password', 'en'),
    preheader: seedLocalizedText('Secure recovery route prepared.', 'en'),
    body: seedLocalizedText('Use the secure button below to set a new password and continue securely.', 'en'),
    updatedBy: 'Security',
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your renewal is coming up', 'en'),
    preheader: seedLocalizedText('Keep your rhythm continuity active.', 'en'),
    body: seedLocalizedText('Your membership renews in 7 days. Review your plan and continue tracking with no interruption.', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Stay for one more cycle', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Verify your email', 'en'),
    preheader: seedLocalizedText('One secure step to activate your account.', 'en'),
    body: seedLocalizedText('Confirm your email to secure your account and unlock member features.', 'en'),
    updatedBy: 'Security',
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your sign-in link', 'en'),
    preheader: seedLocalizedText('This link expires shortly for your safety.', 'en'),
    body: seedLocalizedText('Use this secure sign-in link to access your account. If you did not request it, ignore this email.', 'en'),
    updatedBy: 'Security',
    updatedAt: '2026-03-02',
  },
  {
    ...
    subject: seedLocalizedText('New sign-in detected on your account', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your trial has started', 'en'),
    preheader: seedLocalizedText('Make the most of your first rhythm week.', 'en'),
    body: seedLocalizedText('Your trial is active. Start with daily check-ins and watch patterns become clear.', 'en'),
    updatedBy: 'Growth Ops',
    updatedAt: '2026-03-02',
  },
  {
    ...
    subject: seedLocalizedText('Your trial ends soon', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('We could not process your payment', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your billing is active again', 'en'),
    preheader: seedLocalizedText('Thank you, your membership continues normally.', 'en'),
    body: seedLocalizedText('We successfully processed your payment. Your access continues with no interruption.', 'en'),
    updatedBy: 'Finance Team',
    updatedAt: '2026-03-02',
  },
  {
    ...
    subject: seedLocalizedText('Your invoice and receipt', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your space is still here for you', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your weekly rhythm summary', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('New tools for your rhythm', 'en'),
    preheader: seedLocalizedText('Explore new capabilities in your member space.', 'en'),
    body: seedLocalizedText('We shipped a new feature to help you track and reflect with less effort and more clarity.', 'en'),
    updatedBy: 'Product Team',
    updatedAt: '2026-03-02',
  },
  {
    ...
    subject: seedLocalizedText('Your support request was resolved', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Important update to privacy terms', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your account was deleted', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('A quiet minute tonight', 'en'),
    preheader: seedLocalizedText('One short note can make tomorrow clearer.', 'en'),
    body: seedLocalizedText('Take one gentle minute tonight. A few honest words are enough.', 'en'),
    updatedBy: 'Product Team',
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your week in review', 'en'),
...
const TEMPLATE_PACK_ADVANCED: EmailTemplate[] = [
  {
    ...
    body: seedLocalizedText('You can return with a single minute tonight. We will continue from where you left.', 'en'),
    updatedBy: 'Retention Team',
    updatedAt: '2026-03-12',
  },
  {
    ...
    subject: seedLocalizedText('Your month in review is ready', 'en'),
  ...
  },
  {
    ...
    subject: seedLocalizedText('Your space is still open', 'en'),
...
const parseTemplates = (value: unknown): EmailTemplate[] => {
  ...
  return value.map((raw, index) => {
    ...
    return {
      ...
      title,
      trigger,
      subject: normalizeLocalized(item.subject, 'Update'),
      preheader: normalizeLocalized(item.preheader, 'A note for you'),
...
export const AdminPanelView: React.FC<AdminPanelViewProps> = ({
  ...
  const [newTemplateSubject, setNewTemplateSubject] = useState('A calm update');
  const [newTemplatePreheader, setNewTemplatePreheader] = useState('Gentle insight for your rhythm.');
  const [newTemplateBody, setNewTemplateBody] = useState('Take one breath, open your map, and choose one small caring step for today.');
  ...
  const buildEmailHtml = (template: EmailTemplate) => {
    ...
    return `<!doctype html><html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>${escapeHtml(subject)}</title></head><body style="margin:0;padding:0;background:#f8fafc;font-family:Arial,sans-serif;color:#0f172a"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:32px 16px"><tr><td align="center"><table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:28px;border:1px solid #e2e8f0;overflow:hidden"><tr><td style="padding:28px;background:linear-gradient(135deg,#f0f9ff,#f5f3ff)"><div style="display:flex;justify-content:space-between;align-items:center"><div style="font-size:34px;font-weight:800;letter-spacing:-0.02em;color:#7c3aed">Luna29</div><div style="font-size:26px">🌙</div></div><p style="margin:6px 0 0;font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#64748b">System email</p></td></tr><tr><td style="padding:28px"><p style="margin:0 0 8px;font-size:12px;text-transform:uppercase;letter-spacing:0.2em;color:#64748b">${escapeHtml(preheader)}</p><h1 style="margin:0 0 12px;font-size:30px;line-height:1.2;color:#0f172a">${escapeHtml(title)}</h1><h2 style="margin:0 0 16px;font-size:18px;color:#7c3aed">${escapeHtml(subject)}</h2><p style="margin:0 0 20px;font-size:16px;line-height:1.75;color:#1e293b">${escapeHtml(body)}</p><div style="margin:0 0 20px"><p style="margin:0 0 6px;font-size:11px;text-transform:uppercase;letter-spacing:0.18em;color:#64748b">Variables</p>${variableBadges}</div><a href="#" style="display:inline-block;padding:12px 20px;background:#7c3aed;color:#ffffff;text-decoration:none;border-radius:999px;font-weight:700;font-size:12px;letter-spacing:0.08em;text-transform:uppercase">Open app</a></td></tr><tr><td style="padding:20px 28px;background:#0f172a;color:#cbd5e1"><p style="margin:0;font-size:12px;line-height:1.6">Rhythm & Balance · www.luna29.com</p></td></tr></table></td></tr></table></body></html>`;
  };
  ...
  const resetTemplateForm = () => {
    ...
    setNewTemplateSubject('A calm update');
    setNewTemplatePreheader('Gentle insight for your rhythm.');
    setNewTemplateBody('Take one breath, open your map, and choose one small caring step for today.');
      ...
      const localized = await localizeFields(
        {
          ...
          subject: newTemplateSubject.trim() || 'Update',
          preheader: newTemplatePreheader.trim() || 'A note for you',
      ...
      if (editingTemplateId) {
        ...
        setTemplates((prev) => prev.map((template) => {
          ...
          const nextTemplate: EmailTemplate = {
            ...
            subject: seedLocalizedText(newTemplateSubject.trim() || 'Update', lang),
            preheader: seedLocalizedText(newTemplatePreheader.trim() || 'A note for you', lang),
        ...
        const createdTemplate: EmailTemplate = {
          ...
          trigger: seedLocalizedText(triggerValue, lang),
            subject: seedLocalizedText(newTemplateSubject.trim() || 'Update', lang),
            preheader: seedLocalizedText(newTemplatePreheader.trim() || 'Email', lang),
          body: seedLocalizedText(newTemplateBody.trim() || defaultTemplateBody, lang),
          variables,
          updatedBy: session?.name || 'Admin',
          updatedAt: new Date().toISOString().slice(0, 10),
  ...
  const sendInvite = async () => {
    ...
    try {
      const result = await adminService.sendAdminInvite({ email, role: inviteRole });
      ...
      setInviteEmail('');
      const deliveryNote = result.delivered ? 'Email delivered.' : 'Link copied (mail provider not configured).';
      setActionFeedback(`Invite sent to ${email}. ${deliveryNote}`);
      await copyTextSafely(result.inviteLink).catch(() => undefined);
    } catch (error) {
      setActionFeedback(error instanceof Error ? error.message : 'Unable to send invite.');
    }
  };
