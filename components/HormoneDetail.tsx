...
const HormoneDetail: React.FC<HormoneDetailProps> = ({ hormone, lang, onClose }) => {
  ...
  ar: { back: 'رجوع', currentState: 'الحالة الحالية', coreMarker: 'المؤشر الأساسي', howItFeels: 'كيف يُشعر', yourExperience: 'تجربتك', dailyImpact: 'التأثير اليومي', howItWorks: 'كيف يعمل', whatItAffects: 'ما يؤثر عليه', whatItAffectsSub: 'أين يشير هذا المؤشر إلى تغيّرات.', whatInfluences: 'ما يؤثر على هذا', whatInfluencesSub: 'عوامل تغيّر هذا الخط الأساسي.', talkToDoctor: 'تحدّثي مع طبيبتك', talkToDoctorSub: 'مفردات منظّمة لاستشارتك.', questionsToAsk: 'أسئلة للسؤال', doctorHint: 'استخدمي هذه الأسئلة لبدء حوار سريري.', addToBrief: 'إضافة إلى الملخّص', privacy: 'وعد الخصوصية مفعّل', privacySub: 'Luna29 مرآة رقمية. هذه الخريطة مراقِبة وتعكس أنماطك المُبلّغ عنها عبر تاريخ إيقاعك.', briefAdded: 'أُضيف إلى الملخّص', briefUpdated: 'تم تحديث الملخّص' },
  he: { back: 'חזרה', currentState: 'מצב נוכחי', coreMarker: 'סמן מרכזי', howItFeels: 'איך זה מרגיש', yourExperience: 'החוויה שלך', dailyImpact: 'השפעה יומית', howItWorks: 'איך זה עובד', whatItAffects: 'מה זה משפיע', whatItAffectsSub: 'היכן הסמן הזה מסמן שינויים.', whatInfluences: 'מה משפיע על זה', whatInfluencesSub: 'משתנים שמזיזים את קו הבסיס.', talkToDoctor: 'דברי עם הרופאה', talkToDoctorSub: 'אוצר מילים מובנה לייעוץ.', questionsToAsk: 'שאלות לשאול', doctorHint: 'השתמשי בשאלות האלה כדי לפתוח שיח קליני.', addToBrief: 'הוספה לתקציר', privacy: 'הבטחת פרטיות פעילה', privacySub: 'Luna29 היא מראה דיגיטלית. המיפוי הזה תצפיתי ומשקף את הדפוסים שדיווחת עליהם לאורך היסטוריית הקצב.', briefAdded: 'נוסף לתקציר', briefUpdated: 'התקציר עודכן' },};
  ...
  ar: { Steady: 'مستقر', Sensitive: 'حسّاس', Stressed: 'متوتر', Changing: 'متغيّر', Active: 'نشط', Quiet: 'هادئ' },
  he: { Steady: 'יציב', Sensitive: 'רגיש', Stressed: 'לחוץ', Changing: 'משתנה', Active: 'פעיל', Quiet: 'שקט' },};
