...
export const MedicationsView: React.FC<{
  ...
  const profileName = hp.pageHeroTitle;
  const copyByLang: LangCopy<{
    ...
    en: { titleA: 'Medication', titleB: 'Note.', subtitle: `Your ${profileName} is the clinical source of truth. Supporting notes below are optional day-to-day observations — not a second medication list.`, close: 'Close', addNew: 'Add supporting note', addSuccess: 'Supporting note added.', removeSuccess: 'Supporting note removed.', name: 'Name', amount: 'Dose', save: 'Save', empty: 'No supporting notes yet.', remove: 'Remove', standardDose: 'Typical dose', addedOn: 'Added on', clinicalTitle: `Current medications (${profileName})`, clinicalEmpty: `No medications in your ${profileName} yet.`, notesTitle: 'Supporting notes', notesSubtitle: `Optional observations only — manage clinical medications in your ${profileName}.` },
    ru: { titleA: 'Заметка', titleB: 'о препарате.', subtitle: `${profileName} — клинический источник истины. Заметки ниже — только вспомогательные наблюдения.`, close: 'Закрыть', addNew: 'Добавить заметку', addSuccess: 'Заметка добавлена.', removeSuccess: 'Заметка удалена.', name: 'Название', amount: 'Дозировка', save: 'Сохранить', empty: 'Пока нет заметок.', remove: 'Удалить', standardDose: 'Типичная доза', addedOn: 'Добавлено', clinicalTitle: `Текущие препараты (${profileName})`, clinicalEmpty: `В ${profileName} пока нет препаратов.`, notesTitle: 'Вспомогательные заметки', notesSubtitle: `Только наблюдения — клинические препараты ведите в ${profileName}.` },
    uk: { titleA: 'Нотатка', titleB: 'про препарат.', subtitle: `${profileName} — клінічне джерело істини. Нотатки нижче — лише допоміжні спостереження.`, close: 'Закрити', addNew: 'Додати нотатку', addSuccess: 'Нотатку додано.', removeSuccess: 'Нотатку видалено.', name: 'Назва', amount: 'Доза', save: 'Зберегти', empty: 'Поки немає нотаток.', remove: 'Видалити', standardDose: 'Типова доза', addedOn: 'Додано', clinicalTitle: `Поточні препарати (${profileName})`, clinicalEmpty: `У ${profileName} ще немає препаратів.`, notesTitle: 'Допоміжні нотатки', notesSubtitle: `Лише спостереження — клінічні препарати ведіть у ${profileName}.` },
    es: { titleA: 'Nota', titleB: 'de medicación.', subtitle: `Tu ${profileName} es la fuente clínica. Las notas de abajo son observaciones opcionales.`, close: 'Cerrar', addNew: 'Añadir nota', addSuccess: 'Nota añadida.', removeSuccess: 'Nota eliminada.', name: 'Nombre', amount: 'Dosis', save: 'Guardar', empty: 'Aún no hay notas.', remove: 'Eliminar', standardDose: 'Dosis típica', addedOn: 'Añadido el', clinicalTitle: `Medicamentos actuales (${profileName})`, clinicalEmpty: `Aún no hay medicamentos en tu ${profileName}.`, notesTitle: 'Notas de apoyo', notesSubtitle: `Solo observaciones — gestiona medicamentos clínicos en tu ${profileName}.` },
    fr: { titleA: 'Note', titleB: 'médicament.', subtitle: `Votre ${profileName} est la source clinique. Les notes ci-dessous sont des observations optionnelles.`, close: 'Fermer', addNew: 'Ajouter une note', addSuccess: 'Note ajoutée.', removeSuccess: 'Note retirée.', name: 'Nom', amount: 'Dose', save: 'Enregistrer', empty: 'Pas encore de notes.', remove: 'Retirer', standardDose: 'Dose typique', addedOn: 'Ajouté le', clinicalTitle: `Médicaments actuels (${profileName})`, clinicalEmpty: `Aucun médicament dans votre ${profileName}.`, notesTitle: 'Notes complémentaires', notesSubtitle: `Observations uniquement — gérez les médicaments cliniques dans votre ${profileName}.` },
    de: { titleA: 'Medikamenten', titleB: 'notiz.', subtitle: `Dein ${profileName} ist die klinische Quelle. Notizen unten sind optionale Beobachtungen.`, close: 'Schließen', addNew: 'Notiz hinzufügen', addSuccess: 'Notiz hinzugefügt.', removeSuccess: 'Notiz entfernt.', name: 'Name', amount: 'Dosis', save: 'Speichern', empty: 'Noch keine Notizen.', remove: 'Entfernen', standardDose: 'Typische Dosis', addedOn: 'Hinzugefügt am', clinicalTitle: `Aktuelle Medikamente (${profileName})`, clinicalEmpty: `Noch keine Medikamente im ${profileName}.`, notesTitle: 'Ergänzende Notizen', notesSubtitle: `Nur Beobachtungen — klinische Medikamente im ${profileName} pflegen.` },
    zh: { titleA: '用药', titleB: '备注。', subtitle: `${profileName}是临床信息来源。下方备注仅为可选日常观察。`, close: '关闭', addNew: '添加备注', addSuccess: '备注已添加。', removeSuccess: '备注已删除。', name: '名称', amount: '剂量', save: '保存', empty: '暂无备注。', remove: '移除', standardDose: '常用剂量', addedOn: '添加于', clinicalTitle: `当前用药（${profileName}）`, clinicalEmpty: `${profileName}中尚无用药记录。`, notesTitle: '辅助备注', notesSubtitle: `仅作观察 — 请在${profileName}中管理临床用药。` },
    ja: { titleA: '服薬', titleB: 'メモ。', subtitle: `${profileName} が臨床の情報源です。下のメモは任意の観察です。`, close: '閉じる', addNew: 'メモを追加', addSuccess: 'メモを追加しました。', removeSuccess: 'メモを削除しました。', name: '名前', amount: '用量', save: '保存', empty: 'メモはまだありません。', remove: '削除', standardDose: '一般的な用量', addedOn: '追加日', clinicalTitle: `現在の服薬（${profileName}）`, clinicalEmpty: `${profileName} に服薬がありません。`, notesTitle: '補足メモ', notesSubtitle: `観察のみ — 臨床の服薬は ${profileName} で管理してください。` },
    pt: { titleA: 'Nota', titleB: 'de medicação.', subtitle: `Seu ${profileName} é a fonte clínica. As notas abaixo são observações opcionais.`, close: 'Fechar', addNew: 'Adicionar nota', addSuccess: 'Nota adicionada.', removeSuccess: 'Nota removida.', name: 'Nome', amount: 'Dose', save: 'Salvar', empty: 'Ainda sem notas.', remove: 'Remover', standardDose: 'Dose típica', addedOn: 'Adicionado em', clinicalTitle: `Medicamentos atuais (${profileName})`, clinicalEmpty: `Ainda sem medicamentos no ${profileName}.`, notesTitle: 'Notas de apoio', notesSubtitle: `Apenas observações — gerencie medicamentos clínicos no ${profileName}.` },
    ar: { titleA: 'ملاحظة', titleB: 'دواء.', subtitle: `${profileName} هو المصدر السريري. الملاحظات أدناه اختيارية.`, close: 'إغلاق', addNew: 'إضافة ملاحظة', addSuccess: 'تمت إضافة الملاحظة.', removeSuccess: 'تمت إزالة الملاحظة.', name: 'الاسم', amount: 'الجرعة', save: 'حفظ', empty: 'لا ملاحظات بعد.', remove: 'إزالة', standardDose: 'جرعة معتادة', addedOn: 'أُضيف في', clinicalTitle: `الأدوية الحالية (${profileName})`, clinicalEmpty: `لا أدوية في ${profileName} بعد.`, notesTitle: 'ملاحظات داعمة', notesSubtitle: `ملاحظات فقط — أدِر الأدوية السريرية في ${profileName}.` },
    he: { titleA: 'הערת', titleB: 'תרופה.', subtitle: `${profileName} הוא מקור האמת הקליני. ההערות למטה הן תצפיות אופציונליות.`, close: 'סגירה', addNew: 'הוספת הערה', addSuccess: 'ההערה נוספה.', removeSuccess: 'ההערה הוסרה.', name: 'שם', amount: 'מינון', save: 'שמירה', empty: 'עדיין אין הערות.', remove: 'הסרה', standardDose: 'מינון טיפוסי', addedOn: 'נוסף ב', clinicalTitle: `תרופות נוכחיות (${profileName})`, clinicalEmpty: `עדיין אין תרופות ב${profileName}.`, notesTitle: 'הערות תומכות', notesSubtitle: `תצפיות בלבד — נהלי תרופות קליניות ב${profileName}.` },
  };
