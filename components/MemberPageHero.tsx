...
export const MemberPageHero: React.FC<{
  ...
  ar: { about: 'حول', how_it_works: 'كيف يعمل', terms: 'الشروط', medical: 'إخلاء المسؤولية', cookies: 'Cookies', data_rights: 'حقوق البيانات' },
  he: { about: 'אודות', how_it_works: 'איך זה עובד', terms: 'תנאים', medical: 'הצהרת אחריות', cookies: 'Cookies', data_rights: 'זכויות נתונים' },};
  ...
  ar: {
      home: 'طبقة توجيه يومية بأهم الإشارات ونقاط التركيز والخطوات التالية.',
      about: 'خلفية Luna29 وسياق BioMath مع الغرض وحدود النظام.',
      cycle: 'خريطة بصرية للإيقاعات الفسيولوجية: الطاقة والمزاج والتركيز والتعافي.',
      labs: 'تتبّع المقاييس والاتجاهات والتفسيرات العملية لإشارات صحتك عبر الزمن.',
      history: 'مراجعة الجدول الزمني والأنماط المتكررة وما تغيّر عبر الدورات والأيام الأخيرة.',
      create: 'إنشاء تأملات موجّهة ومسودات ورسائل داعمة.',
      profile: 'إدارة إعداداتك الشخصية وتفضيلاتك ومعلومات ملفك.',
      privacy: 'التحكم في ظهور البيانات وإعدادات الموافقة وحدود الخصوصية.',
      bridge: 'تحويل الحالات الداخلية إلى رسائل واضحة ومحترمة لنفسك أو لمن تحبين.',
      family: 'أدوات إيقاع منزلية للتخطيط للحمل وتوقع التوتر والتسجيل المشترك.',
      voice: 'التقاط الأفكار بالصوت وتحويلها إلى تأمل منظّم والحصول على ردود مركّزة.',
      voice_files: 'الوصول إلى التسجيلات الصوتية المحفوظة ومراجعتها وإدارتها.',
      knowledge: 'مواد مرجعية وإرشاد عملي لفهم أنماطك الداخلية.',
      faq: 'إجابات سريعة عن النطاق والأمان والبيانات والاستخدام.',
      support: 'قنوات التواصل والدعم للمساعدة العملية وملاحظات الخدمة.',
      meds: 'سياق تتبّع الأدوية وملاحظات داعمة لروتين الالتزام اليومي.',
      ...
      cookies: 'تفاصيل استخدام cookies والتحكم في الجلسة والتفضيلات والتحليلات.',
      data_rights: 'حقوقك في الوصول والتصدير والتصحيح وحذف البيانات الشخصية.',
    },
  he: {
      home: 'שכבת כיוון יומית עם האותות החשובים, נקודות מיקוד והצעדים הבאים.',
      about: 'רקע Luna29 והקשר BioMath עם מטרת המערכת וגבולותיה.',
      cycle: 'מפת קצבים פיזיולוגיים: אנרגיה, מצב רוח, מיקוד והתאוששות.',
      labs: 'מעקב אחר מדדים, מגמות ופרשנות מעשית של אותות בריאות לאורך זמן.',
      history: 'סקירת ציר זמן, דפוסים חוזרים ומה השתנה בימים ובמחזורים האחרונים.',
      create: 'יצירת רפלקציות מודרכות, טיוטות ומסרים תומכים.',
      profile: 'ניהול הגדרות אישיות, העדפות ופרטי פרופיל.',
      privacy: 'שליטה בנראות נתונים, הגדרות הסכמה וגבולות פרטיות.',
      bridge: 'הפיכת מצבים פנימיים למסרים ברורים ומכבדים לעצמך או לקרובים.',
      family: 'כלי קצב ביתי לתכנון עומס, חיזוי התנגשות וצ׳ק-אין משותף.',
      voice: 'לכידת מחשבות בקול, המרה לרפלקציה מובנית וקבלת תגובות ממוקדות.',
      voice_files: 'גישה, סקירה וניהול של הקלטות קול ותמלילים שמורים.',
      knowledge: 'חומרי עזר והנחיה מעשית להבנת הדפוסים הפנימיים שלך.',
      faq: 'תשובות מהירות על היקף, בטיחות, נתונים ושימוש.',
      support: 'ערוצי תקשורת ותמיכה לעזרה מעשית ומשוב על השירות.',
      meds: 'הקשר מעקב תרופות והערות תומכות לשגרת היענות יומית.',
      ...
      cookies: 'פרטי שימוש cookies ובקרה על session, העדפות ואנליטיקה.',
      data_rights: 'הזכויות שלך לגישה, ייצוא, תיקון ומחיקה של נתונים אישיים.',
    },};
