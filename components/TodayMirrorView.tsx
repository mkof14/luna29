...
export const TodayMirrorView: React.FC<TodayMirrorViewProps> = ({
  ...
  ar: 'Explain today to my partner',
  he: 'Explain today to my partner',};
  ...
  ar: 'Your month with Luna29',
  he: 'Your month with Luna29',};
  ...
  ar: { shared: 'Shared.', copied: 'Copied.', failed: 'Could not share.' },
  he: { shared: 'Shared.', copied: 'Copied.', failed: 'Could not share.' },};
