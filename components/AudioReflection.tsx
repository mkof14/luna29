...
const voiceUiByLang: LangCopy< VoiceReflectionUiCopy> = {
  ...
  ar: {
    listeningLine: 'تحدّثي بحرية. Luna29 تستمع.',
    voiceTitle: 'ملاحظة صوتية',
    voiceSupport: 'سجّلي ملاحظة قصيرة عن شعورك وما حدث خلال يومك.',
    tapToRecord: 'اضغطي للتسجيل',
    shortEnough: '30–60 ثانية تكفي.',
    promptsTitle: 'يمكنك البدء بـ:',
    prompt1: 'ما الذي كان ثقيلاً اليوم؟',
    prompt2: 'ما الذي كان أسهل مما توقعت؟',
    prompt3: 'ما الذي ما زال في ذهنك؟',
    prompt4: 'كيف يشعر جسمك الليلة؟',
    reassurance: 'لا توجد طريقة صحيحة للقول. بضع كلمات صادقة تكفي.',
    recordingState: 'جارٍ التسجيل',
    finish: 'إنهاء',
    discard: 'تجاهل',
    reflectionReceived: 'تم استلام الملاحظة',
    reflectionTitle: 'إليك ملاحظتك',
    reflectionFallback: 'بدوتِ متعبّة اليوم. ذكرتِ ضغطاً في العمل. نمتِ أقل من المعتاد.',
    suggestionTitle: 'اقتراح',
    suggestionText: 'اجعلي هذه الليلة أبطأ ونامي مبكراً.',
    seeRhythm: 'شاهدي إيقاعك',
    saveReflection: 'حفظ الملاحظة',
    shareReflection: 'مشاركة الملاحظة',
    saving: 'جارٍ الحفظ...',
    copied: 'تم نسخ الملاحظة.',
    shareError: 'تعذّرت المشاركة الآن.',
    previousDayLabel: 'أمس شاركتِ',
    compareToday: 'كيف يشعر اليوم مقارنةً بأمس؟',
  },
  he: {
    listeningLine: 'דברי בחופשיות. Luna29 מקשיבה.',
    voiceTitle: 'הערה קולית',
    voiceSupport: 'הקליטי הערה קצרה על איך את מרגישה ומה קרה במהלך היום.',
    tapToRecord: 'הקישי להקלטה',
    shortEnough: '30–60 שניות מספיקות.',
    promptsTitle: 'אפשר להתחיל עם:',
    prompt1: 'מה הרגיש כבד היום?',
    prompt2: 'מה הרגיש קל יותר ממה שציפית?',
    prompt3: 'מה עדיין על הדעת?',
    prompt4: 'איך הגוף שלך מרגיש הערב?',
    reassurance: 'אין דרך נכונה לומר את זה. מספיקות כמה מילים כנות.',
    recordingState: 'מקליט',
    finish: 'סיום',
    discard: 'ביטול',
    reflectionReceived: 'ההערה התקבלה',
    reflectionTitle: 'הנה ההערה שלך',
    reflectionFallback: 'נשמעת עייפה היום. הזכרת לחץ בעבודה. ישנת פחות מהרגיל.',
    suggestionTitle: 'הצעה',
    suggestionText: 'קחי ערב איטי ולכי לישון מוקדם יותר.',
    seeRhythm: 'ראי את הקצב שלך',
    saveReflection: 'שמירת הערה',
    shareReflection: 'שיתוף הערה',
    saving: 'שומר...',
    copied: 'ההערה הועתקה.',
    shareError: 'לא ניתן לשתף כרגע.',
    previousDayLabel: 'אתמול שיתפת',
    compareToday: 'איך היום מרגיש לעומת אתמול?',
  },};
