...
export const ContactView: React.FC<ContactViewProps> = ({ ui, lang, onBack }) => {
  ...
  ar: { back: 'رجوع', sentTitle: 'تم استلام رسالتك', sentText: 'تم إبلاغ فريقنا. سنتواصل معك عبر البريد الإلكتروني قريباً.', sentCta: 'العودة إلى التواصل', supportAvailability: 'توفر الدعم', schedule: 'الاثنين — الجمعة • 9:00 — 18:00 UTC', emailOnly: 'خدمة بريد إلكتروني مخصّصة فقط', namePlaceholder: 'أدخلي اسمك', messagePlaceholder: 'كيف يمكن لفريق الدعم مساعدتك اليوم؟', loadingFallback: 'جارٍ الإرسال...' },
  he: { back: 'חזרה', sentTitle: 'ההודעה התקבלה', sentText: 'הצוות שלנו קיבל את ההודעה. ניצור איתך קשר במייל בקרוב.', sentCta: 'חזרה ליצירת קשר', supportAvailability: 'זמינות תמיכה', schedule: 'שני — שישי • 9:00 — 18:00 UTC', emailOnly: 'שירות דוא״ל ייעודי בלבד', namePlaceholder: 'הזיני את שמך', messagePlaceholder: 'איך צוות התמיכה יכול לעזור לך היום?', loadingFallback: 'שולח...' },};
