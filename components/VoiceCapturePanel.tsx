...
const copyByLang: LangCopy<{
  ...
  ar: {
    tapSpeak: 'اضغطي للتحدث',
    listening: 'أستمع…',
    processing: 'أفهم…',
    unsupported: 'الصوت غير مدعوم في هذا المتصفح. اكتبي بدلاً من ذلك.',
    micDenied: 'تم رفض الوصول إلى الميكروفون.',
    noSpeech: 'لم يُكتشف كلام. حاولي مرة أخرى.',
    hint: 'تحدّثي بحرية — Luna تملأ التفاصيل.',
  },
  he: {
    tapSpeak: 'הקישי כדי לדבר',
    listening: 'מקשיבה…',
    processing: 'מבינה…',
    unsupported: 'קול לא נתמך בדפדפן הזה. אפשר להקליד במקום.',
    micDenied: 'הגישה למיקרופון נדחתה.',
    noSpeech: 'לא זוהה דיבור. נסי שוב.',
    hint: 'דברי בטבעיות — Luna ממלאת את הפרטים.',
  },
};
