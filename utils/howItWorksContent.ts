...
export const EXTRA_HOW_COPY: LangCopy< ExtraHowCopy> = {
  ...
  ar: {
    dailyTitle: 'هيكل الاستخدام اليومي (90 ثانية)',
    dailyItems: [
      'الصباح: حدّدي خط الأساس (الطاقة، المزاج، التركيز).',
      'منتصف النهار: راجعي السعة وعدّلي عبء العمل.',
      'المساء: أضيفي تأملاً قصيراً أو voice note.',
    ],
    onboardingTitle: 'بداية موجّهة لـ 7 أيام',
  ...
  he: {
    dailyTitle: 'מבנה שימוש יומי (90 שניות)',
    dailyItems: [
      'בוקר: קבעי baseline (אנרגיה, מצב רוח, מיקוד).',
      'צהריים: בדקי קיבולת והתאימי עומס.',
      'ערב: הוסיפי רפלקציה קצרה או voice note.',
    ],
    onboardingTitle: 'התחלה מודרכת של 7 ימים',
...
export const COPY: LangCopy< Copy> = {
  ...
  ar: {
    eyebrow: 'كيف يعمل',
    title: 'من الإشارة اليومية إلى قرارات واضحة',
    subtitle: 'Luna29 تحوّل المدخلات اليومية الصغيرة إلى أنماط إيقاع مرئية، لتفهمي نفسك أسرع وتتصرفي بضغط أقل.',
    flowTitle: 'مسار بسيط من 4 خطوات',
    flow: [
      { step: '01', title: 'Check-in يومي', text: 'تسجيل قصير يلتقط الطاقة والمزاج والتوتر والنوم والسياق.', icon: 'pulse' },
      { step: '02', title: 'رؤية النمط', text: 'Luna29 ترسم التغيّرات عبر الأيام والدورات لتصبح الأنماط واضحة لا عشوائية.', icon: 'map' },
      { step: '03', title: 'إرشاد لطيف', text: 'النظام يقترح خطوات بسيطة للإيقاع والعناية والتواصل.', icon: 'guide' },
      { step: '04', title: 'فعل وتأمل', text: 'تعدّلين الخطط، تشاركين ملاحظات للشريك، وتبنين روتيناً أكثر هدوءاً مع الزمن.', icon: 'bridge' },
    ],
    benefitsTitle: 'ما تفهمينه بسرعة',
    benefits: [
      { title: 'لماذا تشعرين باختلاف يوماً بعد يوم', text: 'تصبح تغيّرات الحالة مفسّرة في سياق الإيقاع.' },
      { title: 'متى تدفعين ومتى تحمين طاقتك', text: 'تتجنّبين الإرهاق بمواءمة الخطط مع سعتك الفعلية.' },
      { title: 'كيف تتواصلين عن احتياجاتك بوضوح', text: 'أدوات Bridge تقلّل الصراع وتحسّن الفهم مع الشريك.' },
    ],
    faqTitle: 'إجابات سريعة',
    faq: [
      { q: 'هل Luna29 أداة تشخيص طبي؟', a: 'لا. إنها نظام للمراقبة الذاتية ودعم القرار.' },
      { q: 'كم يستغرق الاستخدام اليومي؟', a: 'عادةً نحو 60 ثانية يومياً للـ check-in الأساسي.' },
      { q: 'هل بياناتي خاصة؟', a: 'نعم. البنية local-first مع وصول محكوم في منطقة الأعضاء.' },
    ],
    commentsTitle: 'تعليقات الأعضاء',
    comments: [
      { quote: 'أخيراً فهمت أن انخفاضات طاقتي لم تكن عشوائية.', author: 'آنا • 32' },
      { quote: 'الـ check-in لـ 60 ثانية جعل روتيني واقعياً.', author: 'ميا • 28' },
      { quote: 'ملاحظات Bridge ساعدتني أشرح حالتي دون صراع.', author: 'سارة • 35' },
    ],
    cta: 'ابدئي تجربة 7 أيام',
  ...
  he: {
    eyebrow: 'איך זה עובד',
    title: 'מסימן יומי להחלטות ברורות',
    subtitle: 'Luna29 הופכת קלטים יומיים קטנים לדפוסי קצב נראים, כדי שתביני את עצמך מהר יותר ותפעלי בפחות לחץ.',
    flowTitle: 'מסלול פשוט ב-4 שלבים',
    flow: [
      { step: '01', title: 'Check-in יומי', text: 'check-in קצר לוכד אנרגיה, מצב רוח, לחץ, שינה והקשר.', icon: 'pulse' },
      { step: '02', title: 'לראות את הדפוס', text: 'Luna29 ממפה שינויים לאורך ימים ומחזורים כדי שהדפוסים יהיו ברורים, לא אקראיים.', icon: 'map' },
      { step: '03', title: 'הדרכה עדינה', text: 'המערכת מציעה הצעות קלות לקצב, טיפול עצמי ותקשורת.', icon: 'guide' },
      { step: '04', title: 'פעולה והתבוננות', text: 'מתאימות תוכניות, משתפות הערות לבן/בת זוג ובונות שגרה רגועה יותר עם הזמן.', icon: 'bridge' },
    ],
    benefitsTitle: 'מה מבינים במהירות',
    benefits: [
      { title: 'למה מרגישים שונה מיום ליום', text: 'שינויי מצב הופכים מוסברים בהקשר של הקצב.' },
      { title: 'מתי לדחוף ומתי לשמור אנרגיה', text: 'נמנעים מעומס יתר על ידי התאמת תוכניות לקיבולת.' },
      { title: 'איך לתקשר על צרכים בבהירות', text: 'כלי Bridge מפחיתים קונפליקט ומשפרים הבנה עם בן/בת הזוג.' },
    ],
    faqTitle: 'תשובות מהירות',
    faq: [
      { q: 'האם Luna29 כלי אבחון רפואי?', a: 'לא. זו מערכת להתבוננות עצמית ותמיכה בהחלטות.' },
      { q: 'כמה זמן לוקח השימוש היומי?', a: 'בדרך כלל כ-60 שניות ביום ל-check-in הליבה.' },
      { q: 'האם הנתונים שלי פרטיים?', a: 'כן. ארכיטקטורת local-first עם גישת חברים מבוקרת.' },
    ],
    commentsTitle: 'תגובות חברות',
    comments: [
      { quote: 'סוף סוף הבנתי למה ירידות האנרגיה שלי לא היו אקראיות.', author: 'אנה • 32' },
      { quote: 'ה-check-in של 60 שניות הפך את השגרה שלי לריאלית.', author: 'מיה • 28' },
      { quote: 'הערות Bridge עזרו לי להסביר את המצב בלי קונפליקט.', author: 'שרה • 35' },
    ],
    cta: 'התחילי ניסיון של 7 ימים',
