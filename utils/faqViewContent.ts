  ...
  uk: [
    {
      ...
      items: [
        { q: "Що таке Luna29 Balance?", a: "Luna29 Balance - це система візуального картування фізіологічних ритмів. Вона допомагає бачити, як гормони пов'язані з енергією, настроєм і відновленням." },
        { q: "Для кого ця система?", a: "Для жінок, які хочуть краще розуміти своє тіло в різні етапи циклу та життя." },
        { q: "Чим це відрізняється від звичайних трекерів циклу?", a: "Більшість трекерів передбачають дати. Luna29 дивиться ширше: стрес, метаболізм, відчуття та патерни стану." },
    ...
    },
    {
      ...
      items: [
        { q: "Це медичний продукт?", a: "Ні. Luna29 є цифровою освітньою системою для самоспостереження і не надає медичну послугу." },
        ...
        { q: "Чи дає система діагнози?", a: "Ні. Luna29 не призначає лікування і не встановлює діагнози. Медичні рішення ухвалюються з лікарем." }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Чи працює Luna29 з гормональною контрацепцією?", a: "Так. Картина може бути більш стабільною, але щоденні відмітки все одно допоможуть побачити індивідуальні реакції." }
      ]
    },
    {
      title: "Дані і приватність",
      items: [
        { q: "Де зберігаються мої дані?", a: "Luna29 працює за local-first підходом: дані зберігаються на вашому пристрої." },
  ...
  es: [
    {
      ...
      items: [
        { q: "¿Qué es Luna29 Balance?", a: "Luna29 Balance es un sistema visual para mapear tus ritmos fisiológicos y entender cómo se relacionan con tu energía y estado emocional." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "¿Da diagnósticos o tratamiento?", a: "No. Luna29 no diagnostica ni prescribe. Las decisiones médicas deben tomarse con un profesional." }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { q: "¿Y si mi ciclo es irregular?", a: "Luna29 es flexible: puedes ajustar el mapa según señales reales de tu cuerpo." },
  ...
  fr: [
    {
      ...
      items: [
        { q: "Qu’est-ce que Luna29 Balance ?", a: "Luna29 Balance est un système visuel qui cartographie vos rythmes physiologiques pour mieux comprendre votre énergie et votre humeur." },
        { q: "À qui s’adresse ce système ?", a: "À toute femme qui souhaite mieux lire les signaux de son corps au quotidien." },
        { q: "En quoi est-ce différent d’une application de cycle classique ?", a: "Luna29 ne se limite pas aux dates. Elle intègre stress, métabolisme et ressenti global." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Donne-t-il un diagnostic ?", a: "Non. Luna29 ne diagnostique pas et ne prescrit pas de traitement." }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Et si mon cycle est irrégulier ?", a: "Luna29 est flexible: vous pouvez aligner la carte sur vos signaux réels." },
  ...
  de: [
    {
      ...
      items: [
        { q: "Was ist Luna29 Balance?", a: "Luna29 Balance ist ein visuelles System, das physiologische Rhythmen abbildet und damit Energie- und Stimmungsmuster sichtbar macht." },
        ...
        { q: "Was ist der Unterschied zu klassischen Zyklus-Apps?", a: "Luna29 geht über Datumsprognosen hinaus und bezieht Stress, Stoffwechsel und Alltagszustand ein." },
    ...
    },
    {
      ...
      items: [
        { q: "Ist das ein Medizinprodukt?", a: "Nein. Luna29 ist ein digitales Selbstbeobachtungs- und Lernsystem." },
        { q: "Ersetzt es Ärztinnen oder Ärzte?", a: "Nein. Es hilft, Beobachtungen für einen Arzttermin besser zu strukturieren." },
        { q: "Stellt Luna29 Diagnosen?", a: "Nein. Es werden keine Diagnosen oder Therapien vorgegeben." }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { q: "Was bei unregelmäßigem Zyklus?", a: "Luna29 ist flexibel und kann an reale Körpersignale angepasst werden." },
  ...
  zh: [
    {
      title: "基础理解",
      items: [
        { q: "什么是 Luna29 Balance？", a: "Luna29 Balance 是一个可视化系统，用于映射你的生理节律，帮助你理解能量与情绪变化。"},
    ...
    },
    {
      title: "医疗与安全",
      items: [
        { q: "这是医疗产品吗？", a: "不是。Luna29 是用于自我观察和学习的数字工具。"},
        { q: "它能替代医生吗？", a: "不能。它用于帮助你在就诊前整理观察信息。"},
        { q: "它会给出诊断或治疗吗？", a: "不会。Luna29 不提供诊断与处方。"}
      ]
    },
    {
      title: "激素与日常生活",
    ...
    },
    {
      ...
      items: [
        ...
        { q: "如果周期不规律怎么办？", a: "Luna29 支持按你的真实体征进行调整，而不是固定天数。"},
  ...
  ja: [
    {
      title: "基本理解",
      items: [
        { q: "Luna29 Balanceとは？", a: "Luna29 Balanceは、生理的リズムを可視化し、エネルギーや気分の変化を理解するためのシステムです。" },
    ...
    },
    {
      title: "医療と安全性",
      items: [
        { q: "医療製品ですか？", a: "いいえ。Luna29は自己観察のためのデジタルツールです。" },
  ...
  pt: [
    {
      ...
      items: [
        { q: "O que é Luna29 Balance?", a: "Luna29 Balance é um sistema visual para mapear ritmos fisiológicos e entender mudanças de energia e humor." },
    ...
    },
    {
      ...
      items: [
        ...
        { q: "A plataforma dá diagnóstico?", a: "Não. Luna29 não diagnostica nem prescreve tratamento." }
      ]
    },
    {
