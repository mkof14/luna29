...
export type HomeStory = {
  ...
  const pricingCopyByLang: LangCopy< { title: string; subtitle: string; month: string; year: string; monthNote: string; yearNote: string; saveBadge: string; cta: string; recommended: string }> = {
    ...
    ru: {
      ...
      cta: 'Купить Доступ Luna29',
      recommended: 'Рекомендация: $12.99/месяц для текущего этапа роста продукта.',
    },
    uk: {
      title: 'Прозора Та Проста Ціна',
      subtitle: 'Один план. Повний доступ до зони учасника Luna29. Оберіть місяць або рік.',
      month: '$12.99',
      year: '$89',
      monthNote: 'за місяць',
      yearNote: 'за рік',
      saveBadge: 'Економія 25% на річному плані',
      cta: 'Купити Доступ Luna29',
      recommended: 'Рекомендація: $12.99/місяць для поточного етапу розвитку.',
    },
    es: { title: 'Precio Claro Y Simple', subtitle: 'Un plan con acceso completo. Elige mes o ano.', month: '$12.99', year: '$89', monthNote: 'por mes', yearNote: 'por ano', saveBadge: 'Ahorra 25% anual', cta: 'Comprar Acceso Luna29', recommended: 'Recomendado: $12.99/mes.' },
    fr: { title: 'Tarif Clair Et Simple', subtitle: 'Un seul plan. Acces complet. Paiement mensuel ou annuel.', month: '$12.99', year: '$89', monthNote: 'par mois', yearNote: 'par an', saveBadge: '25% d economie annuelle', cta: 'Acheter Luna29', recommended: 'Recommande: $12.99/mois.' },
    de: { title: 'Klare Einfache Preise', subtitle: 'Ein Plan, voller Zugang. Monatlich oder jahrlich.', month: '$12.99', year: '$89', monthNote: 'pro Monat', yearNote: 'pro Jahr', saveBadge: '25% sparen jahrlich', cta: 'Luna29 Kaufen', recommended: 'Empfehlung: $12.99/Monat.' },
