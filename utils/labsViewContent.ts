...
const reportUiByLang: Partial<LangCopy< {
  ...
  en: {
    ...
    sampleView: 'View Sample Report',
    sampleDownload: 'Download Sample Report',
  ...
  ru: {
    ...
    sampleView: 'Смотреть образец отчета',
    sampleDownload: 'Скачать образец отчета',
  ...
  uk: {
    ...
    sampleView: 'Переглянути приклад звіту',
    sampleDownload: 'Завантажити приклад звіту',
  ...
  es: {
    ...
    sampleView: 'Ver reporte de ejemplo',
    sampleDownload: 'Descargar reporte de ejemplo',
  ...
  fr: {
    ...
    sampleView: 'Voir l’exemple de rapport',
    sampleDownload: 'Télécharger l’exemple de rapport',
  ...
  de: {
    ...
    sampleView: 'Beispielbericht ansehen',
    sampleDownload: 'Beispielbericht laden',
  ...
  ja: {
    ...
    sampleView: 'サンプルレポートを見る',
    sampleDownload: 'サンプルレポートをダウンロード',
  ...
  pt: {
    ...
    sampleView: 'Ver relatório de exemplo',
    sampleDownload: 'Baixar relatório de exemplo',
  ...
  ar: {
    ...
    sampleView: 'عرض تقرير نموذجي',
    sampleDownload: 'تنزيل تقرير نموذجي',
  ...
  he: {
    ...
    sampleView: 'צפייה בדוח לדוגמה',
    sampleDownload: 'הורדת דוח לדוגמה',
