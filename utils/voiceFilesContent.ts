...
export type VoiceFilesCopy = {
  ...
  ar: {
      back: 'رجوع',
      title: 'ملفاتي الصوتية',
      subtitle: 'تسجيلات محفوظة من Voice Note. شغّلي، ابحثي، رشّحي وأديري ملفاتك.',
      search: 'البحث في النص...',
      allLanguages: 'كل اللغات',
      fromDate: 'من',
      toDate: 'إلى',
      clearFilters: 'مسح الفلاتر',
      clearAll: 'حذف كل الملفات',
      noFiles: 'لا توجد ملفات صوتية محفوظة بعد.',
      filesCount: 'ملفات',
      download: 'تنزيل',
      delete: 'حذف',
      transcript: 'النص',
  ...
  he: {
      back: 'חזרה',
      title: 'קבצי הקול שלי',
      subtitle: 'הקלטות שמורות מ-Voice Note. נגני, חפשי, סנני ונהלי את הקבצים.',
      search: 'חיפוש בתמליל...',
      allLanguages: 'כל השפות',
      fromDate: 'מ',
      toDate: 'עד',
      clearFilters: 'נקי מסננים',
      clearAll: 'מחקי את כל הקבצים',
      noFiles: 'עדיין אין קבצי קול שמורים.',
      filesCount: 'קבצים',
      download: 'הורדה',
      delete: 'מחיקה',
      transcript: 'תמליל',
