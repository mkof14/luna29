...
const MAX_PUBLIC_LANDING_GZIP = Number(process.env.MAX_PUBLIC_LANDING_GZIP || 52 * 1024);
const MAX_INDEX_CSS_GZIP = Number(process.env.MAX_INDEX_CSS_GZIP || 36 * 1024);
