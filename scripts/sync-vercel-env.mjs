...
const vars = {
  ...
  STRIPE_SUCCESS_URL: local.STRIPE_SUCCESS_URL || `${PRODUCTION_SITE}/?tab=profile&billing=success`,
  STRIPE_CANCEL_URL: local.STRIPE_CANCEL_URL || `${PRODUCTION_SITE}/pricing?billing=canceled`,
  STRIPE_PORTAL_RETURN_URL: local.STRIPE_PORTAL_RETURN_URL || `${PRODUCTION_SITE}/?tab=profile`,
